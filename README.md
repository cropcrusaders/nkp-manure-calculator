...
content provided by different types of manure. It helps farmers and gardeners
determine how much nitrogen (N), phosphorus (P₂O₅), potassium (K₂O) and other
essential elements are contributed by a given quantity of manure.
...
1. Open `index.html` directly in your browser, or serve the site locally with
   ...
   ```
2. Choose the manure type from the dropdown menu.
3. Enter the quantity and unit (kilograms or pounds).
4. Click **Calculate** to see the nutrient breakdown.
